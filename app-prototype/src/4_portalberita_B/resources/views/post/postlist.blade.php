          ...
          <thead class="thead-dark">
            <tr>
              ...
              <th width="150" class="text-center">
                <a class="btn btn-success" href="{{asset('/')}}post/create"> 
          ...
          <tbody>
            ...
            <tr>
              ...
              <td class="text-center">
                <a class="btn btn-secondary" href="{{asset('/')}}post/{{ $row->id }}">
                  <i class="fas fa-info-circle"></i>
                </a>
                <a class="btn btn-warning" href="{{asset('/')}}post/{{ $row->id }}/edit">
                  <i class="far fa-edit"></i>
                </a>
                <a class="btn btn-danger" href="{{asset('/')}}post/{{ $row->id }}/delete">
